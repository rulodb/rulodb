...
async fn test_order_by_string_ascending() {
    ...
    println!(
        "Testing order by string ascending, ID: {}, database: {}, table: {}",
...
async fn test_order_by_number_descending() {
    ...
    println!(
        "Testing order by number descending, ID: {}, database: {}, table: {}",
        query_id, database_name, table_name
    );
...
async fn test_order_by_multiple_fields() {
    ...
    println!(
        "Testing order by multiple fields, ID: {}, database: {}, table: {}",
        query_id, database_name, table_name
    );
...
async fn test_order_by_with_timeout() {
    ...
    println!(
        "Testing order by with custom timeout, ID: {}, database: {}, table: {}",
        query_id, database_name, table_name
    );
...
async fn test_order_by_nonexistent_table() {
    ...
    println!(
        "Testing order by on nonexistent table, ID: {}, database: {}, table: {}",
        query_id, database_name, table_name
    );
...
async fn test_order_by_empty_table() {
    ...
    println!(
        "Testing order by on empty table, ID: {}, database: {}, table: {}",
        query_id, database_name, table_name
    );
